...
> _Sessions_ allow a server to store information about a client.

- [x] What does bcrypt do to help us store passwords in a secure manner.
> Bcrypt hashes passwords with a _salt_ so that it is not easily decoded.

- [x] What does bcrypt do to slow down attackers?
> Bcrypt can introduce a time-complexity by hashing the password multiple times.
